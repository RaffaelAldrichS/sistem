...
<template>
  <nav class="bg-white border-gray-200 dark:bg-[#232536]">
    <div
    ...
    >
      ...
      >
        <img :src="Brand" class="h-6" alt="Flowbite Logo" />
      </RouterLink>
      ...
      >
        <ul
          class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-[#232536] md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0"
        >
          <li>
            <RouterLink
              to="/"
